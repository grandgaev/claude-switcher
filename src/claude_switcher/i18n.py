...
_EN: dict[str, str] = {
    ...
    "err.nothing_to_save": "Nothing to save: .credentials.json is missing, even if account info is still cached in .claude.json. Sign into Claude Code and try again.",
    "err.account_not_saved": "Account “{name}” isn't saved.",
    "err.no_credentials_to_switch": "Account “{name}” has no saved credentials — switching to it would log you out with no way back. Log into that account in Claude Code, then save it again.",
...
_RU: dict[str, str] = {
    ...
    "err.nothing_to_save": "Нечего сохранять: .credentials.json отсутствует, даже если данные аккаунта ещё кешированы в .claude.json. Залогинься в Claude Code и попробуй снова.",
    "err.account_not_saved": "Аккаунт «{name}» не сохранён.",
    "err.no_credentials_to_switch": "У «{name}» нет сохранённых credentials — переключение на него разлогинит тебя без возможности вернуться. Залогинься под этим аккаунтом в Claude Code и сохрани его заново.",
